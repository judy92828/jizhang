...
<div id="body" class="weixin">
    ...
    <div class="weui_panel_bd">
        <?php if(is_array($expend)): $i = 0; $__LIST__ = $expend;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="javascript:void(0);" class="weui_media_box weui_media_appmsg">
